...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try
	{
		...
		cmdInsertValue->CommandText = "INSERT INTO " + text + " (Название,Издатель,Автор,Год) VALUES('"+textBox1->Text+"', '" + textBox2->Text + "', '" + textBox3->Text + "', " + textBox4->Text + ");";
